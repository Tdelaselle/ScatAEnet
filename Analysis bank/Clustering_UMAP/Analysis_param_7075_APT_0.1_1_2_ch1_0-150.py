...
data_file = "Stream_7075_APT_0.1_1_2_ch1_0-150.pkl"
DIRPATH = "data/Fatigue_INSA/" # for local computing
# DIRPATH = "/data/failles/delaselt/continuous_AE_data/" # for OAR computing 
data_param = "Parametric_data/Param_data_assembly/Param__APT_0.1_1_2_ch1_0-150"     # Folder and file (without extension)
