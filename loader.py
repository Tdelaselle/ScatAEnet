...
import tqdm
import xarray as xr
import Analysis_param

# -------------------------------------------- filepaths and parameters
data_file = Analysis_param.data_file
DIRPATH = Analysis_param.DIRPATH
model_file = Analysis_param.model_file
param_path = Analysis_param.data_param
pooling = Analysis_param.pooling
